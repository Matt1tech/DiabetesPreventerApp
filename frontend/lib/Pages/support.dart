...
class _ClientSupportPageState extends State<ClientSupportPage> {
  ...
  final String adminEmail = const String.fromEnvironment('SUPPORT_EMAIL');
  final String adminPhoneNumber = const String.fromEnvironment('SUPPORT_PHONE');
  String? user_id;
  ...
  Future<void> _launchDialer() async {
    if (adminPhoneNumber.isEmpty) return;
      ...
      child: ExpansionTile(
        ...
        children: [
          ...
          TextButton.icon(
            ...
            label: Text(
              adminPhoneNumber.isEmpty
                  ? 'Phone support not configured'
