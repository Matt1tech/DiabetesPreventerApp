  ...
  static Future<void> setMaxDailyCalories(int userId, int maxCalories) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit daily calories max: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> setMaxDailyCarbs(int userId, int maxCholesterol) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit daily carbs max: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> setMaxDailyFat(int userId, int maxFat) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit daily fat max: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> setMaxDailyFiber(int userId, int maxFiber) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit daily fiber max: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> setMaxDailyProtein(int userId, int maxProtein) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit daily protein max: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> setMealPerDay(int userId, List<String> meals) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit meals per day: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> allergies(int userId, List<String> allergies) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit allergies: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> dietsFollowed(int userId, List<String> diets) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit diets followed: ${response.statusCode}');
      }
    } catch (e) {
