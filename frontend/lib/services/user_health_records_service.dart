  ...
  static Future<void> inputBloodGlucose(int userId, int bloodGlucose) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit blood glucose data: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> inputBloodPressure(int userId, int bloodPressure) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit blood pressure data: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> inputDailyWeight(int userId, int weight) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('Failed to submit Daily Weight: ${response.statusCode}');
      }
    } catch (e) {
